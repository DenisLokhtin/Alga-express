...
// export const packageInfo = '/user/package/info/'; Нигде не используется
...
export const listBuyouts = '/user/buyouts/list';
...
export const editTariffGroup = '/cargo/tariff/edit';
