    ...
    return (
        <Container style={{'border': '2px solid #2E2E2E', 'borderRadius': '3px', 'margin': '10px 0 20px 0'}}
            ...
            <Grid style={{'marginBottom': '15px'}} component='div'>
                ...
                товаров из интернет-магазинов США, Китая и Турции в Бишкек. У нас действуют наиболее низкие тарифы на
                рынке Бишкека.
                ...
                После оформления покупок в интернет-магазинах все заказы поступают на наш основной склад. Далее посылки
