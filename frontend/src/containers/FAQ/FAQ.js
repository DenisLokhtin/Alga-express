            ...
            <Grid style={{'marginBottom': '15px'}} component='div'>
                <div className="page-content">
                    ...
                    <p>
                        ...
                        можете быть уверенны, что приобретете товар отличного качества по наиболее низкой цене. Нельзя
                        также забывать про ОГРОМНЫЕ распродажи, когда скидки на товары могут достигать 90%. Для
                        сравнения можете открыть любой интернет-магазин, выбрать интересующий Вас товар и сравнить цены
                        с местными.
                    </p>
                    <p>&nbsp;</p>
                    ...
                    <p>
                        ...
                        компания сотрудничает с одним из крупных и проверенных перевозчиков из США в СНГ, что позволяет
                        нам получать низкие цены на перевозку из США в Кыргызстан.
                    </p>
                    <p>&nbsp;</p>
                    <p><strong>Q: Я бы хотел самостоятельно оформлять заказы в американских интернет магазинах. Что для
                    ...
                    <p>
                        ...
                        обороты. Большое количество онлайн-магазинов концентрируются только на торговле по интернету.
                        Таким магазинам очень важно мнение клиентов об их работе, так как в интернете очень легко найти
                        любую негативную информацию. Кроме того, законодательство США строго конролирует их
                        деятельность. Наш список онлайн-магазинов содержит наиболее популярные площадки, где Вы сможете
